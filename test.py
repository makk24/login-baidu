...
if __name__ == '__main__':
  ...
  #   req2 = request.Request(url=date_url, data=datepostdata, headers=head)
    ...
    filename = 'cookie.txt'
    file_context = open(filename).read().splitlines()
    f = open('runlog.txt','a',encoding='utf-8')
    ...
    #此处的open方法打开网页
    response = opener.open('http://ext.baidu.com/api/subscribe/v1/relation/status?callback=_box_jsonp655')
    #保存cookie到文件
