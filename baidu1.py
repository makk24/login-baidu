...
session.get('https://www.baidu.com', headers=headers,verify=False)
...
def get_token(gid, callback):
    ...
    headers.update(dict(Referer='http://www.baidu.com/', Accept='*/*', Connection='keep-alive', Host='passport.baidu.com'))
...
def login(token, gid, callback, rsakey, username, password):
    post_data = {
        ...
        'codestring': '1234',
        'safeflg': 0,
        'u': 'http://www.baidu.com/disk/home',
        'isPhone': '',
        'detect': 1,
        'gid': gid,
        'quick_user': 0,
